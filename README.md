...
CLI tools for maintaining a local LLM-assisted philosophy wiki.
...
- `src/wiki_cli/`: package code for SEP import, Markdown conversion, indexing,
  linting, and activity logging
